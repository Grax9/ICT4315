...
public class ParkingOfficeTests {
  ...
  public static void setUp() {
    ...
    cars.add(new Car("permit", LocalDate.now(), "license", CarType.SUV, customer));
    cars.add(new Car("permit1", LocalDate.now(), "license1", CarType.COMPACT, customer));
  ...
  public void testRegisterCustomer() {
    ...
    Customer customer = parkingOffice.register("Jimmy", "123 Main St.", "1234567890");
  ...
  public void testGetCustomer() {
    ParkingOffice parkingOffice = new ParkingOffice("testOffice", "testAddress", customers, cars, lots, charges);
    Customer customer = parkingOffice.register("FindMe", "123 Main St.", "1234567890");
   ...
   */
  @Test
  public void testParkingChargesCustomer() {
    ParkingOffice parkingOffice = new ParkingOffice("testOffice", "testAddress",
        customers, cars, lots, ParkingOfficeTests.charges);

    Customer customer = parkingOffice.register("Joe", "123 Main St", "1234567890");
